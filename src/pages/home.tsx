...
import DeviceImage from "../assests/device.jpg";
            ...
            >
              <div className="flex">
                <div className="flex-shrink-0 flex flex-col">
                  ...
                  />
                  <div className="w-0.5 mx-auto flex-1 !bg-white dark:!bg-black"></div>
                </div>
                  ...
                  <div className="flex lg:hidden flex-col gap-3 ml-4">
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                      ...
                      {techStack.map((tech) => (
                        <div
                          key={tech.name}
                          className="rounded-lg pl-2 pr-4 py-2 bg-[#121212] flex items-center gap-3 tech-icon"
                        >
                          <img
                            src={tech.image}
                            alt={tech.name}
